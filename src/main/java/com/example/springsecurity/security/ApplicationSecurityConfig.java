...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
//                Should not be disabled in real env
//                If enabled cookie returned that needs to be sent in header as X-XSRF-TOKEN
//
                .csrf().disable()
...
//                 More complex way then annotations on each route with @EnableGlobalMethodSecurity(prePostEnabled = true) -> and does not work for some reason in this implementation
//
